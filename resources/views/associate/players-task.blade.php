...
@section('content')
<div class="tab-block oa-players-task-tab-block">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="image-block yellow">
                                            <img src="assets/images/icon7.png" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <h4>Tasks today</h4>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="image-block blue">
                                            <img src="assets/images/icon8.png" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <h4>Overdue</h4>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="image-block green">
                                            <img src="assets/images/icon9.png" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <h4>Backlogs</h4>
                ...
                <div class="tab-bottom-block">
                    <div class="filter-block oa-players-task-filter-block">
                        <div class="row">
                    ...
                    <table class="oa-tasks table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Task ID</th>
                                <th>User</th>
