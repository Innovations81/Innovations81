$(document).ready(function () {
  ...
  if ($(".fm-top-withdrawals").length > 0) {
    ...
    FMTopWithdrawalsTable = $('.fm-top-withdrawals').DataTable();
    $('.fm-top-withdrawals-tab-block .input-search').keyup(function () {
      FMTopWithdrawalsTable.search($(this).val()).draw();
    });
  }
  ...
  if ($(".fm-top-deposit").length > 0) {
    ...
    FMTopDepositTable = $('.fm-top-deposit').DataTable();
    $('.fm-top-deposit-tab-block .input-search').keyup(function () {
      FMTopDepositTable.search($(this).val()).draw();
    });
  }
